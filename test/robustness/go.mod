module github.com/faroshq/kube-foundationdb/test/robustness

go 1.25.0

replace (
	github.com/faroshq/kube-foundationdb => ../..
...
require (
	...
	github.com/faroshq/kube-foundationdb v0.0.0-00010101000000-000000000000
